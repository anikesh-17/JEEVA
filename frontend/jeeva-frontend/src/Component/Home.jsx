...
function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#e5fdf2] p-2 overflow-x-hidden">
      ...
      {/* Top Section */}
      <div className="w-full h-14 flex justify-between relative  items-center">
        ...
        <div className="relative">
          ...
          >
            ...
            <GoTriangleDown className={`text-zinc-600 transition-all duration-300 ${
    showProfileCard ? "rotate-180" : "rotate-0"
  }`}  size={20} />
          </div>
          ...
          {showProfileCard && (
            <div className="absolute right-0 mt-2 w-48 bg-white shadow-xl rounded-lg p-3 z-50">
              ...
              <p className="font-semibold">Anup Kumar</p>
              <p className="text-sm text-gray-600 mb-2">anup@gmail.com</p>
              ...
              <button className="w-full text-left px-2 py-1 hover:bg-gray-100 rounded text-red-600">
                Logout
              </button>
